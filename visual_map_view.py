...
class VisualMapView:
    ...
    def __init__(self, parent, gridMap):
        ...
        # create visual map panel
        self.panel = DirectFrame(
            parent=parent,
            frameColor=(0.08, 0.08, 0.08, 0.9),
            frameSize=(-0.02, 0.78, -0.83, 0.08),
            pos=(0.04, 0, -0.08)
        )
        ...
        self.texture = Texture("visualMapTexture")

        card = CardMaker("visualMapCard")
        card.setFrame(0.04, 0.72, -0.72, -0.04)
